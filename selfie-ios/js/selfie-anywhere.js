...
const backgrounds = ["background.63f1bc03.63f1bc03.jpeg", "dfe8bb26.jpg", "CasinoRenderNew1_04.jpg", "CasinoRenderNew1_05.jpg"];
...
function setBackground(index) {
    $('#selfie-anywhere-app').css('background-image', 'url(' + backgroundImagesPath + backgrounds[index] + ')');
    $('#background-container').css('background-image', 'url(' + backgroundImagesPath + backgrounds[index] + ')');
};
